...
// fix: embedding 使用独立的千问 endpoint，chat 使用 DeepSeek

const COLLECTION_NAME =
  process.env.MILVUS_COLLECTION_NAME ?? 'weekly_report_examples';
const VECTOR_DIM = 1024;

// 1. 初始化 Chat 模型（DeepSeek）
...
const vectorStore = await Milvus.fromExistingCollection(embeddings, {
  ...
  // 与 weekly-report-examples-writer-milvus-fix.mjs 中创建的索引保持一致
  indexCreateOptions: {
    index_type: 'IVF_FLAT',
    metric_type: 'COSINE',
    params: { nlist: 1024 },
